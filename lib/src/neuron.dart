...
class Neuron {
  ...
  late final ActivationFunction
      activationPrime; // The derivative of the activation function
  ...
  double get output {
    assert(inputs.isNotEmpty,
        'This neuron has not been supplied with any inputs, thus it cannot produce an output');
